...
**Widely adopted and extended by**: [Wilgat Wong](https://github.com/Wilgat) in projects such as [pix-client](https://github.com/Wilgat/pix-client), [poe-client](https://github.com/Wilgat/poe-client), [SyncPrjs](https://github.com/Wilgat/SyncPrjs), [pomo](https://github.com/Wilgat/pomo), [ChronicleLogger](https://github.com/Wilgat/ChronicleLogger), [certbot-nginx](https://github.com/Wilgat/certbot-nginx), [mariadb-galera](https://github.com/Wilgat/mariadb-galera), etc.
